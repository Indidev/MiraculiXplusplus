...
export AX_PROJECTS="Core;Gui;RobotAPI;MemoryX;VisionX;SimulationX;Spoac;SpeechX;RobotSkills;Armar3"
...
alias re="so;sa"
alias start="$ArmarX_DIR/scripts/start.sh"
alias stop="$ArmarX_DIR/scripts/stop.sh"
alias gui="$ArmarX_DIR/Gui/build/bin/ArmarXGuiRun"
alias guikill="killall -9 ArmarXGuiRun"
alias cmdall="$ArmarX_DIR/scripts/cmdall.sh"
...
alias inp="$ArmarX_DIR/scripts/inproject.sh"
alias mk="inp \"cd build;make\""
alias cmk="inp \"cd build;cmake ..\""
alias sc=". $ArmarX_DIR/scripts/scenario.sh"
alias p=". $ArmarX_DIR/scripts/project.sh"
alias h="p"
